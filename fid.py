...
def calculate_fid2(images1, images2, use_multiprocessing, batch_size):
    ...
    with np.load("pretrained/fids/fid_cifar10_train.npz",) as data:
        mu2, sigma2 = data['mu'], data['sigma']
    fid = calculate_frechet_distance(mu1, sigma1, mu2, sigma2)
    return fid
